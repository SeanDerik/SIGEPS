...
const EspecialidadeEspecialista = require('./models/EspecialidadeEspecialista');
const EspecialistaChamado = require('./models/EspecialistaChamado');
const Especialistas = require('./models/Especialistas');
const Sistemas = require('./models/Sistemas');
const StatusChamado = require('./models/StatusChamado');
const TipoManutencao = require('./models/TipoManutencao');
const TipoSistema = require('./models/TipoSistema');
